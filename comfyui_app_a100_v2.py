...
extra_cmds = [
    ...
    f'wget -O {MODELS_DIR}/diffusion_models/DAF-ZIT.safetensors "https://civitai.com/api/download/models/2479247?type=Model&format=SafeTensor&size=full&fp=fp16" || curl -L -o {MODELS_DIR}/diffusion_models/DAF-ZIT.safetensors "https://civitai.com/api/download/models/2479247?type=Model&format=SafeTensor&size=full&fp=fp16"',
]
